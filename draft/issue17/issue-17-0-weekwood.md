...
本期话题是关于安全，比较而言这一期的话题内容较少 - 我们真的希望包含更多的这个话题的文章，但是九月份对我们和我们的贡献者来说都是异常忙碌的月份，由于时间限制几篇文章都来不及加入这个话题之中，如果你没来得及阅读之前的话题，现在你补救的机会来了。
...
然而，本期话题之中依然有三篇极好的文章。首先，Graham 谈到了关于[为什么今天安全仍然重要](/issue-17-1)。接着，Thomas 竭尽所能阐明对每一个 iOS 和 OS X 开发者来说最大的噩梦：[代码签名内幕](/issue-17-2)。最后但并非最不重要的一点是，Laurent 带着我们学习了如何进行[收据验证](/issue-17-3)。
...
此外，我们还有额外一些内容带给你们。在我们发布的新书 ([Swift 中的函数式编程](http://objc.io/books))后，我们决定建立一个新的简讯：[函数片段](http://objc.io/snippets)。每周，我们将通过邮件发送给您一份帮助你学习和带来灵感的 Swift 代码片段。
...
我们不希望这个简讯扰乱到 objc.io 的邮件列表，所以如果你希望收到相关的邮件，请在[这里注册](http://objc.io/snippets)。
