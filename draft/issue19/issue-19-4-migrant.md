...
大概 10 年前，[Sun Microsystems](https://en.wikipedia.org/wiki/Sun_Microsystems) 创建了 DTrace，它的名字是 *Dynamic Trace* 的缩写。2007 年底，苹果公司将它集积在自己的 [操作系统](https://en.wikipedia.org/wiki/Mac_OS_X_Leopard) 中。
