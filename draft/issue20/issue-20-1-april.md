...
**Andy，谢谢你花时间接受采访。可以跟我们谈谈你是如何开始编程的吗？**
...
我想我应该跟很多人一样是从游戏开始的。曾几何时，我是不被允许玩游戏机的，于是那会儿我就经常去公共图书馆。我九岁的时候，我发现那些我以为教编程的书其实只是罗列了源码。还有一些书整本都是源码，而且都是为游戏设计的。于是当我想玩游戏的时候就把这些源码输入计算机，但又常常半路遇到语法错误而我当时又不能理解这些错误信息，也不知道如何解决。所以我不得不重来一遍，直到我终于可以玩这个游戏，如此反复之后我意识到我可以修改这个游戏， and very rapidly things degraded from there。我学了 C++ - 大概是我10岁的时候 - 因为人们是用它写游戏的，我试图写一个 [MUD](http://en.wikipedia.org/wiki/MUD) 游戏 - 那是我第一个大项目。结果还挺成功...
...
在单玩家模式下所有都可以很正常的运行，但并没有完成多玩家的情况 - 所以我想答案应该是没有吧。我开始转移我的注意力到图形方向，开始迷恋上 GL 和 3D 渲染之类的事情。
...
我做了一阵游戏引擎之类的东西，看了所有 OpenGL 的教程，旋转的方块啊，颗粒引擎啊这些东西，然后我开始做真正的游戏。在那个时候，对一个13岁的我来说，那真是繁复的工作。我发现我没有足够好的图形工具来显示游戏内容。于是，我跟我的室友开始做一个像素编辑器。它叫做 Pixen 。那是我第一次接触 Cocoa 而且它是开源的。当我们发布1.0版本的时候，我当时大概14岁吧，我们去购物中心里面苹果商店的 OS X Panther （还是 Jaguar ？）的发布会。那个时候他们就开始搞这个了！我们想赠送像素编辑器的 CD。
...
**是不是有其他的什么可能你就不会成为一个程序员了？你当时还发现其他特别有趣的事吗？**
...
我当时的愿望就是成为某种工程师。我当时对电气工程挺着迷的，即便是中学的那些化学小实验，所以当时是想成为这种类型的，而软件工程是我当时真正可以着手做的。当时我叫它编程，而不是软件工程，于是有些人告诉我：“不对，你应该叫它计算机科学！”当然，在当时，我并不明白计算机科学，软件工程和编程当中暗流汹涌的文化差异，我只觉得是有用的清晰的术语。但其实我们把它们用错了。
...
我肯定不是计算机科学家，虽然我是超这方向训练的。我觉得我差不多算是软件工程师，一个深受计算机科学影响的软件工程师。不过我最近花了更多时间做一些儿童发育方面的研究，读论文和书籍，分析设想，我们希望能在这个方向略尽绵力。
...
这个， 我想我可以从其他一些事来回答这个问题... 我之前去了 Caltech，这所学院支持了大量的自然科学项目，诸如 NASA 和 DARPA，所以当时的讨论都集中在人性化影响上。当时有一个 NASA 的管理员过来对我们说：“好了，你们是最优秀的。你们将去世界上最好的研究学院之一，而且你们有特权，所有的可能性都向你们敞开怀抱。对你们而言真是太棒了。那么现在你们必须利用它们来做些真正有意义的事情。”
...
When I got out in the broader software community，我是唯一一个没有去做研究的。我毕业的时候我希望能做一些事情，但我对大多数商业软件销售目标和实际销售量非常失望，于是我冥思苦想到底可以在哪个领域发挥专场。踏出的第一步真正决定了将来的方向。我深受物理学家 [David Deutsch](http://en.wikipedia.org/wiki/David_Deutsch) 的影响，通过他确认了我想要走扩展人类知识和能力范围的方向。于是我就想到了我怎样才可以做到。
...
如果我们能活得更久一些，我们会扩大我们的市场，那么在生物技术和化学工程会有很多的机遇。如果我们有更好的工具进行试验，也会扩大我们的市场，于是工具制造，综合工具，虚拟现实就很有吸引力，特别是人工智能。但最终基于我的背景和机遇，我认为对教育做一些贡献是更好的方向。因为如果我可以创造一个终生学习的一代，那么我们将有更多的人来解决这些问题。
...
是的，那是我的期望。学习的一大挑战就是元学习（meta learning）。那是一种可以不必摧毁自信或学习态度的学习方式。如果我打造的这些工具 不但可以让毕业生得到相同成绩，并且他们最终对数学有更好的认知并且他们会更倾向于在之后的生活中学习数学，那我就很满足了。

**So clearly you think that the schools and universities we have already are not good enough — could you elaborate on this?**

**看起来很显然你并不满意我们已有的大学教育？你可以详细谈谈吗？ **
...
是的，它还不够好，并且在很多方面都不够好。最缺乏的是没有让学生得到刚才我说到的那些资源，我觉得那是最重要并且最首要改善的事情。所以这就是为什么现在的任务是给所有人提供免费教育，而 Khan Academy 的使命是为大家提供*世界一流*的免费教育。我们基本上就是先将重点集中在为大家提供免费教育上面，接下来会是世界一流的免费教育，但那是后续的事了，因为我对什么才能算是世界一流还有一些不太满意。
...
是啊。如果你问什么是数学，大多数人都会回答说：“哦，数学很无聊。”或者“我数学不好，我不太喜欢数学。”。如果你问他们对科学的态度，答案也类似。但如果是文学，或许他们会谈论一些他们觉得有趣的书籍里的细节，但那也只是他们学生时代的习惯，现在已经停止了。所以我认为我期望影响的最大的改变将是人们认为在大学毕业之后教育也就终止了这一认知。而这其实并不是一个技术问题，所以我有些给我自己贴上“软件工程师”的标签。虽然我大部分的经验与之相关，但我的目标是在别的地方。
...
眼下，学习的标准已经被普遍认可。我的意思是，不论是读一本书，看一个视频还是一个演讲，你都是被动的吸收知识。你只用坐在那接收，或许如果你有点闲钱还可以在之后有些交谈。但当你毕业之后，你必须自己去创造这样的学习环境。我对所谓的构建式学习环境（constructivist learning environments）很感兴趣。这是一个几十年前的一位学习研究者 [Papert](http://en.wikipedia.org/wiki/Seymour_Papert) 创造的术语。在构建式学习环境下，学生由被动的从教科书里学习转变成自主的创造知识。在这样的模式下，会更像时创造了一种环境，让你在这样的氛围中积极主动的理解事物继而掌握它们。
...
Papert 的研究里有一个例子，他尝试用 [Logo](http://en.wikipedia.org/wiki/Logo_(programming_language)) 来教学生抽象及程序性思维，而不是编程本身。 所以他有一个教室里挂了一个 Logo 的海龟的标志。那时候还有一种机械海龟，可以在纸上作画。这个教室四周挂满了画，有些是源代码生成的，有些不是。画还会随着时间的推移换掉，因为有些学生会看到比如说一朵花然后说：“哦，我喜欢那个图，能给我吗？”然后教师会说：“当然可以，不过你必须输入这些代码，海龟会按代码画出这个图。”接着学生会说：“好的。”然后开始画画，或者看上其他画作，但那些并没有源代码。
...
教室里其他的画作是被设计出来的，需要学生理解原理后制作出来。创造性环境就这样塑造出来了。我正在研究的这个看上去大概会研究很多年假说，首先是允许人们自助的构建知识，那么将很可能得到同样的学习效果，当然如果达到这一结果我会非常高兴。
...
**除了用构建式方式鼓励人们更主动的学习之外，另一个鉴于你在 Khan Academy 做的和更传统的教育方式之间的主要区别是更自由的选择想学习什么以及什么时候学习。那么你觉得这个改变的影响是什么呢？**
...
另一个儿童发育研究者 [Piaget](http://en.wikipedia.org/wiki/Jean_Piaget) 对此有很多的研究成果。他认为对青年一代的开发当中最重要的事情之一是对自主性的训练。而这里的自主性比我们平时认为的自主性还要更宽的范围。除了“我可以随便的玩”这样的自主性之外，还包括了“我正在对我生活中基本上所有的的事情做决定”。这跟其他人来告诉你要怎么分配你的时间或诉诸权威是相抵触的。比如说，常规性的回答“Bobby 在玩游戏的时候作弊了”这样的问题，会是“哦，我去找他谈谈”。与之相反的是，如果是自主性的回答将会是“那么你是怎么跟 Bobby 说的？”。我认为自主性的训练在各方面都是非常重要的。有些研究建议说这会在短期内得到更好的效果，但我认为从长期来说也会引导出更好的思考者。
...
我对那种一整天的日程都被别人安排的情况很质疑。我认为如果一个导师以渐渐的调整学生的学习环境来达到修正学生学习进程的方式会是更积极的。确切一点，举个例子，一次性给学生全部人类知识的目录，并且把每一个都按重要程度分类，我认为更好的方式把所有的知识都看成是书架上的书，然后按难易程度由低到高的摆放。
...
当然，我怀念那儿的人，这是很重要的。事实上我现在对这个行业有一些失望。有这么多优秀的人被局限在这些巨型公司里，他们只是偶尔被善加利用，但更经常的情况只是一台机器的零件，但以他们的智慧其实可以做很大的贡献并且影响深远。我并不是说一定要来我这个项目，我是指更广泛的情况。我不仅仅是因为精神层面的想念，我更怀念的是诸如当时在 NeXT 和那些非常有经验的人进行的非常有激发性的谈话，这都让我感觉有些伤感。但我仍然希望他们可以发挥更大的影响力。
...
**可以多分享一下在 Apple 的时光吗？创造一个被如此多人使用的架构是个什么体验？而你又是怎么从建造游戏一步步走到那一步的？**
...
填补这中间的鸿沟的一件事是当我16岁的时候，我写了一个叫 Sparkle 框架。它让我认识到了到了一些框架开发的现实，比如说你要修改 people 的 API，然后他们生气了。这是框架开发的 基本现实之一，但老实说我其实并不知道我当时在干嘛直到我到了 Apple。我完成了学业，我有了更大的雄心，而 Apple 看起来是个非常好的学习地点，也确实是。其实现在也仍然是，所以我还是会跟那些跟我当时抱一样想法的人相同的建议。跟我共事的是打造了这个框架超过十年的人们，而我差不多是当中垫底的。于是我被迫非常快速的学习和理解许多设计这种规模框架的特别而独特的角度。尤其是框架于二进制兼容的问题，而 Sparkle 并没有考虑过。幸运的是，我周围的人非常慷慨的付出他们的时间和精力帮助我，对我制导很深。在犯了很多很多错误之后，我意识到我都干了些什么蠢事儿，而当几年后我离开之后大概再也用不到那些技术。

**What was the biggest surprise for you in building frameworks at this scale?**

**建造这样大型规模的框架里面最让你吃惊的是什么**
...
我认为二进制兼容时最让我吃惊的事情。我并不理解当中的困难和复杂。这都是通过 bug 渐渐清晰的，比如在 iOS8，按钮时白色背景，但在 iOS7，它时透明的。iOS8 还没有发布，所以这肯定是我们自己的问题。于是你开始一点点钻研发现可能在 iOS7 里调用的一个方法是控制这个的，但这个方法在 iOS8 里已经不被调用了。然后很快的你为了知道怎么回事，会分解，追溯，然后发现这是一个第三方的代码，而且你并没有代码源。基本上有一半的时间，有些人在做一些奇怪的令人发指的事达到效果，而另一半时间我们用一些非常规的手段做了些改变，于是我们需要因此增加一些补丁。
...
**听上去 Peter Steinberger 走的是另一个方向， 拆解 UIKit 来修正 bug**
...
是的，肯定是。版本发布如此的隐秘我们不可能问：“嗨，Facebook 的哥们儿，你们为什么要这么做啊？”我们必须自己搞明白。在这一点上我非常的敬佩 Peter 跟他的团队的工作。我认为那是非常好的事情，也很乐意看到更多这样的事。我期待看到更多框架开发的团队。Facebook 付出了非常好的贡献，Gibut 也是。

**I've never thought of the fact that Apple also has to disassemble other people's binaries to figure out bugs.***

**我从来没想过 Apple 也需要逆向编译其他人的包来分析 bug**
...
是啊，现在作为一个第三方开发者，我不得不 时不时的逆向编译 UIKit，因为我想知道“UIKit，你在干嘛啊？”而回答这个问题最简单的方式就是逆向编译。

**There was a ton of new stuff last year. What are you really excited about? You're also excited about Swift?**

**去年有无数多的新产品面世，你真正感兴趣的是什么？你对 Swift 感兴趣么？**
...
是，我得说这些都挺让人激动的。但当说到我真正兴奋的事情，并不是消费软件工程行业。可以帮助我的工作的那一类最让我激动的是真正的交互式原型工具。比如你想要做一个以前从来不存在的交互，或者有这样的概念但并没有真正的工具的交互的时候。我们大多数仍然只是在 Photoshop 中去设计它。当你在 Photoshop 上设计的时候，你只是在创造一个你在 Photoshop 中设计的一样的东西。我记得在 Apple 的时候，我可以分辨出最初从 Photoshop 还是 After Effects 还是现场模型中得来的需求，这之间有非常大的区别。现在有一些工具可以做这件事，虽然我觉得他们都没有做对，但我还是非常热诚的关注着，希望能有所贡献。
...
是的，Framer 是一个不错的例子。我对刚刚被 Google 收购的那个 Form 这样的产品很感兴趣， 当然还有 Origami，很有意思。我在 Apple 参与了一个原型工具的内部项目，它在有些方面要做的好一些，而另一些方面欠缺一些。每种工具都有优点缺点，我们差不多维护了一个表单罗列着“这个工具可以用来干这个，那个工具更适合做那个”我们不得不来回挑选。我认为它们并没有在某个方面特别的擅长除了做那些非常类似于早已存在的工具做的事情。
...
这个我并不这么认为，但我想我必须进一步解释一下。交互有离散模式和连续模式。像鼠标点击就是离散模式的交互而手势就是连续模式的交互。类似的，你的应用也有离散状态和连续状态。例如滚动就是连续的而导航到导航栈的其他层就是离散的。
...
Storyboard 只允许你控制那个四四方方的空间内的离散区域。因此你可以点屏幕上一个东西，然后有一个离散事件传送到另一个另一个地方。虽然这种交互是最常见的而且说实话我认为这种交互占据了大部分，因为我们一个工具来让我们思考其他模式的交互方式。
...
不过从 iOS7 起，这种离散模式也慢慢淡出视线。比如可以点击一个表单的单元格然后展出单元格下面的内容。这是一些很简单的例子但却很难用 storyborad 实现。

**We would need more [Bret Victor](http://worrydream.com)s working on that problem.**

**我们需要更多像 [Bret Victor](http://worrydream.com) 这样的人来解决这个问题。**

We do, and that's part of why I wish fewer people were making photo-sharing apps.

是的，那也是为什么我希望大家不要再做照片分享类 app 的原因。
...
我阅读了各种不同领域的资料，我仍然在思考这个问题。最近让我注目的是儿童发育或者教育，教学模式这些方面。我读到的最让我兴奋的调查结果是有一个班的5名一年级学生，老师并没有给他们常规的数学指导，而是一系列慢慢调整的活动的这样一个氛围，而这些活动都是游戏。一年之后，他们进行了评估，虽然这些学生并没有学习正式的算术方法，但他们都能够回答问题并且有非常独特的认知。这样的事情让我非常的激动。
...
首先因为他们真的非常慷慨的花时间来做我的导师。在 Apple 总是有很多的挑战，Apple 的文化有个问题是它并不看重导师的价值。因为 Apple 对此没有特别的奖励，而且教导和学习也没有被纳入文化构建当中来。
...
不管怎样，我真的非常幸运能有人花了很多时间来教我做事，并且当我犯了严重错误的时候能花时间主动帮助我。那么是什么这样高效呢？大概是他们的经验吧。这个行业现在非常有趣，因为充斥了新毕业生，而正是这些新毕业生在 Twitter 上叽叽喳喳，在会议上演讲。但这个行业已经形成有一段时间了，肯定有很多拥有15或20年相关领域经验的软件工程师，而他们并不经常发声。你很难听到他们的声音，因为他们基本上都不在大公司里，他们不说但是他们肯定知道很多。

**At Khan Academy, you and your team adopted Swift very quickly. Can you tell us a bit about your experience?**

**在 Khan Academy，你跟你的团队很快的就适应了 Swift。你可以跟我们分享一下你的经验吗？**
...
我们大概有20000行 Swift 的代码，而那个项目有四位贡献者，都写 Swift 代码。我想这个问题我已经谈过的就是实用和理想主义的问题。我确定语言本身的问题都是暂时的，并不能造成宏观的影响，基本上无论什么应用你都可以再6个月时间做出来，那么这些问题都不重要。所以可以对我的抱怨半信半疑，只要专业软件开发的生态系统的长期健康发展，我认为这将会是一个非常好的贡献，而头几个月的磕磕碰碰不值一提。
...
On the plus side, it has helped us to write clearer code. That's the primary thing that I enjoy when I read a Swift interface. When I read a block of Swift code, I have a much better idea of what's happening and what's not going to happen. I can see return values and the return values tell me more. I can use enums to model more accurately the states of the system, we can use value types in order to constrain and confine and limit dependencies, most critically. More broadly, we can move toward this pattern that I strangely endorse, which is really treating UIKit as a library and not as a framework. 
 ...
 积极的一面来说，Swift 让我们的代码更清晰。这是我读 Swift 接口的时候让我最高兴的事情。比如 Swift 的 block 代码，我可以更清楚当前发生以及接下来要发生的事情。我可以看到返回值并且返回值可以让我理解更多。我可以用更准确的方式来枚举模型里的系统状态。我们可以更准确的以约束，限制，依赖的方式来使用值类型。更广的说，我很赞同这种把 UIKit 当成一种库而不是框架的模式。
...
如果说问题的话，没有工具，工程师也不能深究。事实上我其实觉得 Apple 的 Swift 开发团队是最优秀的团队，但是工作还没有完成。现在还到处都是 bug，经常崩溃，偶尔还会生成错误代码。对我们来说更重要的是，它真的很慢。非常非常慢。不能增长式编译是最大的问题。我们编译一个界面应用，基本上我要用我所有的时间思考怎么提升学习，但某个时候我必须来优化交互和动画，虽然只是短时间的打断但真的影响很大 - 并不仅仅是效率而是士气。这让所有人都很愤怒，基本上所有时间所有人都很愤怒。更糟的是，这让我们变懒了。我们不想改，所以如果用 Swift 实现的 UI 比 Objective-C 实现的 UI 更难看我一点都不会吃惊，因为在上面的迭代总是让我们崩溃。
...
但那只是暂时的，我并不对此担忧。他们知道这些而且肯定会修正这个问题。只是你无法管理预期，不是出于恶意，我认为 Apple 其实不知道而且之前并没有做过这么大型的东西。
...
我认为如果我们到10年之后，API 将会完全不一样。我对此深信不疑，不然肯定会让人非常的失望。某个时候，我想大家会看到注释的更好的头文件...
...
是啊，短期内一定会这样的。Facebook 就做得很好，但那不是 Swift， 是 C++，他们的组件项目我就认为超级赞，这主意太棒了。React 就是个不错的设计。我对我在 Apple 最大的怨言就在此，因为 Apple 的文化并不看重学习，所以没有人阅读。我的意思是没有人读严肃的东西，没有人读杂志，没有人读报纸，没有人知道现在外面正在发生的什么。人们不知道 React 之类的东西，这真让人沮丧。
...
不管怎样，我认为那是非常不错的贡献，而且毋庸置疑的是肯定会有人把 UIKit 或者其他框架当做是库来把它们封装的更好。不过，除非 Apple 自己来做否则不会是一个更好的解决办法，也会永远落后就像永远不搭调一样。
...
基本上都差不多了。我希望可以发布更多的开源的东西。我之前在这上面吃过亏。当你发布开源项的时候，很有趣的是，人们还希望你去维护它。我想软件开源社区的期待还没有被明确。有一些开源软件有自己的社区也能被很好的维护，而另外有一些开源软件是以教育的目的或兴趣被分享的，就不怎么被维护。我基本上只有精力做到后者，因为老实说，软件工程并不是我现在感兴趣处理的问题。
